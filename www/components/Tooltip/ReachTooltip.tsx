/**
 *
 * 👋 This intentional fork is only because we want to control MOUSE_REST_TIMEOUT and LEAVE_TIMEOUT.
 *
...
export const MOUSE_REST_TIMEOUT = 200;
export const LEAVE_TIMEOUT = 0;
